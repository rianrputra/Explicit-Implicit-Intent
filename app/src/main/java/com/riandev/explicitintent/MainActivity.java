    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Rian Rahmawan Putra");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 25);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person person = new Person();
                person.setName("Rian Rahmawan Putra");
                person.setAge(25);
                person.setEmail("rian@mail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "085700100200";
